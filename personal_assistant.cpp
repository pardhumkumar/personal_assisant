    ...
    do
    {
        ...
        if(strcmp(password, "pk")==0){
            ...
            do{
                ...
                else if(strcmp(ch, "open googlemaps") == 0){
                    cout<<"openining googlemaps....."<<endl;
                    string phrase = "opening goolemaps";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    system("start https://www.googlemaps.com");
                }
